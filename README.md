...
> **면책 조항**
> - 본 프로젝트는 **팬 번역**으로, ChaoGames의 허가 하에 비상업적 목적으로 배포됩니다.
...
### 배달의민족 꾸불림체 사용 안내
본 프로젝트는 ㈜우아한형제들의 배달의민족 꾸불림체를 사용합니다.

- **지적재산권**: 배달의민족 꾸불림체의 지적 재산권을 포함한 모든 권리는 ㈜우아한형제들이 보유합니다.
- **사용 및 배포**: 배달의민족 꾸불림체는 개인 및 기업 사용자 모두 영리적·비영리적 목적으로 자유롭게 수정·변경하여 사용하실 수 있습니다.
- **판매 금지**: 글꼴 파일(otf/ttf) 자체를 유료로 판매하는 것은 금지됩니다.
- **번들 사용**: 본 저작권 안내를 포함하는 경우 다른 소프트웨어와 번들하거나 재배포하실 수 있습니다.
- **프로모션 활용**: 배달의민족 꾸불림체를 사용한 인쇄물, 광고물(온라인 포함)은 ㈜우아한형제들의 자료 수집 및 연구 목적으로 활용될 수 있습니다. 이를 원치 않는 사용자는 고객센터(1600-0987 / CS@woowahan.com)로 요청하실 수 있습니다.
